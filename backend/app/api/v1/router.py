...
from app.api.v1.routes import auth, calculos, policiais, requerimentos, usuarios
...
api_router.include_router(calculos.router, prefix="/requerimentos", tags=["Cálculos"])
